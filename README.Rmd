...
[![Devel Version](https://img.shields.io/badge/devel%20version-1.0.0.9000-blue.svg)](https://github.com/program--/fipio)
...
### ZCTA/Zip Code Lookup & Reverse Lookup
`fipio` includes information about US Zip Codes as well and provides the utility to find
what FIPS codes are within a ZIP code, and vice versa.
```{r}
# Zip Code -> FIPS code
fipio::zip_to_fips("93106")
```